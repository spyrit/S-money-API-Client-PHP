...
class Pool
{
    ...
    public function getCumulatedAmount()
    {
    ...
    {
        return ($this->AppAccountId = $AppAccountId);
    }
    ...
    {
        return ($this->GoalAmount = $GoalAmount);
    }
    public function setCumulatedAmount($CumulatedAmount)
    {
        return ($this->CumulatedAmount = $CumulatedAmount);
    }
    public function setMotive($Motive)
    {
        return ($this->Motive = $Motive);
    }
    ...
    {
        return ($this->LastOperation = $LastOperation);
    }
