...
class SPExtraResultCodes
{
    ...
    public function setRiskControlResult($RiskControlResult)
    {
        return ($this->RiskControlResult = $RiskControlResult);
    }
    public function setBankAuthResult($BankAuthResult)
    {
        return ($this->BankAuthResult = $BankAuthResult);
    }
    public function setThreedsResult($ThreedsResult)
    {
        return ($this->ThreedsResult = $ThreedsResult);
    }
    public function setCountry($WarrantyResult)
    {
        return ($this->WarrantyResult = $WarrantyResult);
    }
