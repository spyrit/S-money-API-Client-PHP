...
class RegulationHistory extends HistoryItem
{
    ...
    public function getRegulatedOperation()
    {
        return $this->RegulatedOperation;
    }

    public function setRegulatedOperation($RegulatedOperation)
    {
        return ($this->RegulatedOperation = $RegulatedOperation);
    }
