...
class TermsAndConditions
{
    ...
    public function getAreAccepted()
    {
        return $this->AreAccepted;
    }
    public function getLastAcceptanceDate()
    {
    ...
    public function setAreAccepted($AreAccepted)
    {
        return ($this->AreAccepted = $AreAccepted);
    }
    public function setLastAcceptanceDate($LastAcceptanceDate)
    {
        return ($this->LastAcceptanceDate = $LastAcceptanceDate);
    }
    public function setUpdateDate($UpdateDate)
    {
        return ($this->City = $UpdateDate);
    }
