...
class DomainPayment
{
    ...
    public function getDomainClientName()
    {
        return $this->DomainClientName;
    }
    ...
    {
        return ($this->DomainUserId = $DomainUserId);
    }
    public function setDomainName($DomainName)
    {
        return ($this->DomainName = $DomainName);
    }
    public function setDomainClientName($DomainClientName)
    {
        return ($this->DomainClientName = $DomainClientName);
    }
    public function setBeneficiary($Beneficiary)
    {
        return ($this->Beneficiary = $Beneficiary);
    }
    public function setDomainUserName($DomainUserName)
    {
        return ($this->DomainUserName = $DomainUserName);
    }
