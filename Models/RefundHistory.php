...
class RefundHistory extends HistoryItem
{
    ...
    public function getRefundedOperation()
    {
        return $this->RefundedOperation;
    }

    public function setRefundedOperation($RefundedOperation)
    {
        return ($this->RefundedOperation = $RefundedOperation);
    }
